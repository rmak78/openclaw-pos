-- 0008_payroll_approval_workflow.sql
-- Extend payroll run lifecycle to draft|calculated|approved|processed + audit trail

PRAGMA foreign_keys = ON;

ALTER TABLE payroll_runs ADD COLUMN run_code TEXT;
...
CREATE UNIQUE INDEX IF NOT EXISTS uq_payroll_runs_run_code
  ON payroll_runs(run_code)
